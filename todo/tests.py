...
class ViewsTest(TestCase):
    def setUp(self):
        ...
        self.task = Task.objects.create(content="Test Task", deadline="2024-03-10 12:00:00")
...
class AdminTest(TestCase):
    def setUp(self):
        ...
        self.tag = Tag.objects.create(name='Test Tag')
        self.task = Task.objects.create(content='Test Content', deadline='2024-03-10 12:00')
